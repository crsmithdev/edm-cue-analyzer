...
class CuePoint:
    ...
    hot_cue_number: Optional[int] = None  # 0-7 for hot cues A-H
    color: Optional[str] = None
    loop_length: Optional[float] = None  # seconds
...
class CueGenerator:
    ...
    def _calculate_position(self, cue_config: CueConfig, structure: TrackStructure) -> Optional[float]:
        ...
        # Position based on detected structure
            ...
            position = self._position_from_method(
                cue_config.position_method,
                structure
            )
    ...
    def _calculate_position_from_dict(self, cue_dict: Dict, structure: TrackStructure) -> Optional[float]:
    ...
    def _position_from_method(self, method: str, structure: TrackStructure) -> Optional[float]:
        """
    ...
    def _get_drop_position(self, method: str, structure: TrackStructure) -> Optional[float]:
    ...
    def _get_breakdown_position(self, method: str, structure: TrackStructure) -> Optional[float]:
    ...
    def _get_build_position(self, method: str, structure: TrackStructure) -> Optional[float]:
